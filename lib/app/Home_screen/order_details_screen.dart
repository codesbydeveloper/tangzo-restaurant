                          ...
                          Row(
                            ...
                            children: [
                              ...
                              RoundedButtonFill(
                                ...
                                height: 4.2,
                                radius: 10,
                                textColor: Constant.statusTranslatedText(status: controller.orderModel.value.status.toString()),
                                onPress: () async {},
                              ),
                            ],
                          ),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            TranslatedText(
                                              controller.orderModel.value.author!.fullName().toString(),
                                              style: TextStyle(
                                                color: themeChange.getThem() ? AppThemeData.grey50 : AppThemeData.grey900,
                                                fontSize: 14,
                                                fontFamily: AppThemeData.semiBold,
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    product.taxSetting?.isEmpty == true || controller.orderTaxAmount.value > 0
                                                        ? SizedBox()
                                                        : TranslatedText(
                                                            "Tax: ${Constant.getTaxDisplayTranslatedText(product.taxSetting)}",
                                                            maxLines: 2,
                                  ...
                                  controller.orderModel.value.scheduleTime == null
                                      ...
                                      : Row(
                                          children: [
                                            ...
                                            TranslatedText(
                                              Constant.timestampToDateTime(controller.orderModel.value.scheduleTime!),
                                              style: TextStyle(
                                                color: themeChange.getThem() ? AppThemeData.secondary300 : AppThemeData.secondary300,
                                                fontSize: 16,
                                                fontWeight: FontWeight.w500,
