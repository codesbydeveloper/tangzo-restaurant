                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              TranslatedText("Advertisement Type",
                              ...
                              DropdownButtonFormField<String>(
                                  ...
                                  items: controller.advertisementType.map((name) {
                                    return DropdownMenuItem<String>(
                                      value: name,
                                      child: TranslatedText(name.toString()),
                                    );
                                  }).toList()),
                            ],
                          ),
                          Visibility(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TranslatedText("Show Review & Ratings",
                                    style: TextStyle(fontFamily: AppThemeData.semiBold, fontSize: 14, color: themeChange.getThem() ? AppThemeData.grey100 : AppThemeData.grey800)),
                                const SizedBox(
                                  height: 5,
                                ),
                          ...
                          Column(
                            children: [
                              ...
                              TextFieldWidget(
                                  ...
                                  hintText: 'Select the date durations',
                                  suffix: Padding(
                          ...
                          Visibility(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                TranslatedText("Upload Related Files",
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: RoundedButtonFill(
                        radius: 12,
                        title: controller.advertisementModel.value.id != null ? "Edit & Save" : "Submit",
                        height: 5.5,
  ...
  final action = CupertinoActionSheet(
    ...
    actions: <Widget>[
      CupertinoActionSheetAction(
        ...
        child: TranslatedText('Choose Video File'),
      ),
    ],
