                        ...
                        : Padding(
                            ...
                            child: TabBarView(children: [
                              controller.allAdvertisementList.isEmpty
                                  ? Constant.showEmptyView(message: "Advertisement not found.")
                                  : RefreshIndicator(
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            TranslatedText('Ad Created Successfully!', style: TextStyle(color: themeChange.getThem() ? AppThemeData.grey50 : AppThemeData.grey900, fontFamily: AppThemeData.semiBold, fontSize: 16)),
            SizedBox(height: 12),
            TranslatedText(
