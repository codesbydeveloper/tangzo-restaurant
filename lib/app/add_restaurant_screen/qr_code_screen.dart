...
import 'package:restaurant/widget/image_saver.dart';
                ...
                children: [
                  ...
                  RepaintBoundary(
                    ...
                    child: QrImageView(
                      ...
                      backgroundColor: themeChange.getThem() ? AppThemeData.grey900 : AppThemeData.grey50, // White background for QR code
                    ),
                  ),
                  const SizedBox(
                    height: 50,
                ...
                child: RoundedButtonFill(
                  ...
                  onPress: () async {
                    try {
                      ...
                      if (byteData != null) {
                        await ImageSaver.saveImage(byteData.buffer.asUint8List(), "qrcode${DateTime.now().toIso8601String()}.png");
                        ShowToastDialog.showToast("Image Saved!");
                      } else {
