            ...
            appBar: AppBar(
                ...
                bottom: PreferredSize(
                    ...
                    child: Row(
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(left: 55, right: 55, bottom: 8),
                          child: TranslatedText(
                            "${controller.sectionType.value == 'adv' ? "AvdId" : "OrderId"} ${Constant.orderId(orderId: controller.orderId.value.toString())}",
                            style: TextStyle(
                              fontFamily: AppThemeData.medium,
                              fontSize: 14,
                  ...
                  child: GestureDetector(
                    ...
                    child: FirestorePagination(
                      ...
                      itemBuilder: (context, documentSnapshots, index) {
                        ...
                        return chatItemView(themeChange, context, chatmodel.senderId == FireStoreUtils.getCurrentUid(), chatmodel);
                      },
