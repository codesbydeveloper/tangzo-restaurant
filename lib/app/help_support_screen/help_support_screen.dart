                      ...
                      child: GestureDetector(
                        ...
                        child: FirestorePagination(
                          ...
                          itemBuilder: (context, documentSnapshots, index) {
                            ConversationModel conversationModel = ConversationModel.fromJson(documentSnapshots[index].data() as Map<String, dynamic>);
                            return chatItemView(isMe: conversationModel.senderId == FireStoreUtils.getCurrentUid(), data: conversationModel, context: context, controller: controller);
                          },
                        ),
                      ),
                    ),
