              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFieldWidget(
                    ...
                    prefix: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 16),
                      child: SvgPicture.asset("assets/icons/ic_search.svg", width: 24, height: 24),
                    ),
                ...
                Expanded(
                  child: controller.isLoading.value
                      ...
                      : controller.productList.isEmpty == true
                          ? Constant.showEmptyView(message: "No Result Found")
                          : Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 16),
                                                ...
                                                onPress: () async {
                                                  if ((Constant.isSubscriptionModelApplied == true || Constant.adminCommission?.isEnabled == true) &&
                                                    ...
                                                    if (Constant.taxScope == "product" && controller.taxList.isNotEmpty == true) {
                                                      ...
                                                      ShowToastDialog.showToast("Importing product...");
                                                      ...
                                                      ShowToastDialog.showToast("Product imported successfully");
                                                    }
                                                  }
                                                },
                                              ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          TranslatedText(
            "Note: Tax selection is optional. You can add taxes later from manage product section.",
