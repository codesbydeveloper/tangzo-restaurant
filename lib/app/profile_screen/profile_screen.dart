                        ...
                        children: [
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Visibility(
                                            ...
                                            child: (controller.userModel.value.isAutoVerify == false && controller.userModel.value.isDocumentVerify == false) ||
                                                    (controller.userModel.value.vendorID == null || controller.userModel.value.vendorID!.isEmpty)
                                                ? const SizedBox()
                                                : Constant.storyEnable == false
                                                    ? const SizedBox()
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  if (Constant.userModel?.role != Constant.userRoleEmployee && controller.userModel.value.isAutoVerify == false)
                                    cardDecoration(
                                      themeChange,
                                      controller,
                                      Container(
