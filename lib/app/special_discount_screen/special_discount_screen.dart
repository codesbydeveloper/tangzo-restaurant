                                                          ...
                                                          return TextFormField(
                                                              ...
                                                              decoration: InputDecoration(
                                                                ...
                                                                suffix: Padding(
                                                                  ...
                                                                  child: TranslatedText(
                                                                    controller.specialDiscount[index].timeslot![indexTimeSlot].type == "percentage" ? "%" : "${Constant.currencyModel!.symbol}",
                                                                    style: TextStyle(
                                                                        color: themeChange.getThem() ? AppThemeData.grey50 : AppThemeData.grey900, fontFamily: AppThemeData.semiBold, fontSize: 14),
                                                                  ),
                                                                ),
                                                              ));
                                                        }))
                                                ...
                                                Expanded(
                                                  ...
                                                  child: DropdownButtonFormField<String>(
                                                      ...
                                                      items: controller.type.map((item) {
                                                        return DropdownMenuItem<String>(
                                                          value: item,
                                                          child: TranslatedText(item.tr.toString()),
                                                        );
                                                      }).toList()),
                                                ),
                                              ],
