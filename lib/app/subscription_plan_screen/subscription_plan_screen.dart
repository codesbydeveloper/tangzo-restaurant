                  ...
                  children: [
                    ...
                    controller.isLoading.value
                        ...
                        : controller.subscriptionPlanList.isEmpty
                            ? SizedBox(width: Responsive.width(100, context), height: Responsive.height(50, context), child: Constant.showEmptyView(message: "Subscription plan not found."))
                            : ListView.builder(
                        ...
                        return Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: TranslatedText(subscriptionPlanModel.planPoints?[index] ?? '',
                                    maxLines: 2,
                                    style: TextStyle(
                                      fontSize: 14,
                                      fontFamily: AppThemeData.regular,
                    ...
                    Divider(
                        color: controller.selectedSubscriptionPlan.value.id == subscriptionPlanModel.id
                            ...
                            : themeChange.getThem()
                                ...
                                : AppThemeData.grey200),
                    const SizedBox(height: 10),
                    TranslatedText('${"Add item limits :".tr} ${subscriptionPlanModel.itemLimit == '-1' ? 'Unlimited' : subscriptionPlanModel.itemLimit ?? '0'}',
                        maxLines: 2,
                        ...
                        style: TextStyle(
                            ...
                            color: themeChange.getThem()
                                ...
                                : controller.selectedSubscriptionPlan.value.id == subscriptionPlanModel.id
                                    ...
                                    : AppThemeData.grey900)),
                    const SizedBox(height: 10),
                    TranslatedText('${'Accept order limits :'.tr} ${subscriptionPlanModel.orderLimit == '-1' ? 'Unlimited' : subscriptionPlanModel.orderLimit ?? '0'}',
