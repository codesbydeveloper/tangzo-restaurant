...
class AddAdvertisementController extends GetxController {
  ...
  Future<AdvertisementModel?> saveAdvDetails() async {
    if (advertisementTitleController.value.text.isEmpty) {
      ShowToastDialog.showToast("Please enter advertisement title");
      ...
      ShowToastDialog.showToast("Please select advertisement type");
    } else if (validityController.value.text.isEmpty) {
      ShowToastDialog.showToast("Please select the validity durations");
      ...
      ShowToastDialog.showToast("Please select the profile image");
      ...
      ShowToastDialog.showToast("Please select the advertisement cover image");
      ...
      ShowToastDialog.showToast("Please select the advertisement video");
    } else {
      ...
      if (thumbnailFile.value.path.isNotEmpty && selectedAdvertisementType.value == 'Video Promotion') {
        ...
        if (iswide == false) {
          ...
          ShowToastDialog.showToast("Please choose a 2:1 ratio for the cover video.");
          return null;
        }
      }
      ...
      if (modeldata.id != null) {
        ...
        ShowToastDialog.closeLoader();
        ShowToastDialog.showToast("Advertisement details saved successfully.");
        return modeldata;
      } else {
        ShowToastDialog.closeLoader();
        return null;
