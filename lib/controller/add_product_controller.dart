...
class AddProductController extends GetxController {
  ...
  void priceAndDiscountPriceListen() {
    regularPriceController.value.addListener(() {
      ...
      if (discountPrice.value != 0.0 && regularPrice.value < discountPrice.value) {
        ShowToastDialog.showToast("Enter a regular price greater than the discount price.");
      }
    });
    discountedPriceController.value.addListener(() {
      ...
      if (regularPrice.value != 0.0 && discountPrice.value > regularPrice.value) {
        ...
        ShowToastDialog.showToast("Enter a discount price less than the regular price.");
      } else {
  ...
  Future<void> getArgument() async {
    ...
    if (argumentData != null) {
      ...
      if (productModel.value.photos?.isEmpty == true && productModel.value.photo?.isNotEmpty == true) {
        images.add(productModel.value.photo);
      } else {
