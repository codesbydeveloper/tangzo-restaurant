  ...
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData(
      ...
      timePickerTheme: TimePickerThemeData(
        ...
        dialTextColor: isDarkTheme ? AppThemeData.grey400 : AppThemeData.grey800,
        hourMinuteTextColor: isDarkTheme ? AppThemeData.grey400 : AppThemeData.grey800,
        dayPeriodTextColor: isDarkTheme ? AppThemeData.grey400 : AppThemeData.grey800,
      ),
    );
  }
}
